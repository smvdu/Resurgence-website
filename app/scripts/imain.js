...
function type(entry)
{
	...
	document.getElementById("event_selection").value=entry;
	{
		if(entry=="literary")
		{
			text="<ol><li onClick='list_hover(this)'>Debate</li><li onClick='list_hover(this)'>Quiz</li></ol>";	
		}
		else
		if(entry=="music")
		{
			text="<ol><li onClick='list_hover(this)'>Light Indian Vocal</li><li onClick='list_hover(this)'>Qawwali</li><li onClick='list_hover(this)'>Western Vocal</li></ol>";
		}
		else
		if(entry=="art")
		{
			text="<ol><li onClick='list_hover(this)'>Poster Making</li><li onClick='list_hover(this)'>Painting</li></ol>";
		}
		else
		if(entry=="theature")
		{
			text="<ol><li onClick='list_hover(this)'>Skit</li><li onClick='list_hover(this)'>Mime</li></ol>";
		}
		else
		if (entry=="dance") 
		{
			text="<ol><li onClick='list_hover(this)'>Desi Beat</li><li onClick='list_hover(this)'>Folk Dance</li></ol>";
		}
		else
		if(entry=="photo")
		{
			text="<ol><li onClick='list_hover(this)'>Resurgence Cover Shot</li></ol>";
		}
	}
	div.innerHTML=text;
}
